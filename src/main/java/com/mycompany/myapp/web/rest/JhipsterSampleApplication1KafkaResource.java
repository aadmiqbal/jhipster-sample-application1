...
@RestController
@RequestMapping("/api/jhipster-sample-application-1-kafka")
public class JhipsterSampleApplication1KafkaResource {
    ...
    public JhipsterSampleApplication1KafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
